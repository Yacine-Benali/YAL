...
class SimpleNode implements Node {
    ...
    public Object childrenAccept(MyGrammarVisitor visitor, Object data) {
        /**
         * A very dangerous fix for data bubbling up
         * only the data of the last child that returns something will be taken
         **/
        Object lastChildValue = null;
        if (children != null) {
            for (int i = 0; i < children.length; ++i) {
                Object result = children[i].jjtAccept(visitor, data);
                if (result != null) {
                    lastChildValue = result;
                }
            }
...
/* JavaCC - OriginalChecksum=90a861eb0b88cb826b203c81fc54eb29 (do not edit this line) */
